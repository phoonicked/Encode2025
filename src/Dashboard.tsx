...
export default function AgentsDashboard() {
  ...
  return (
    <div className="flex h-screen bg-gray-900 text-gray-300">
      {/* Sidebar */}
      <div className="w-60 border-r border-gray-800 p-4 flex flex-col justify-between">
        <div>
          <div className="flex items-center gap-2 text-lg mb-8 text-purple-300">
            <Bot size={20} />
            <span>Agents</span>
          </div>
      ...
      <div className="flex-1 flex flex-col p-6">
        ...
        <div className="mb-8 relative">
          <input
            ...
            className="w-full py-2 px-4 pr-10 rounded-lg bg-gray-800 text-gray-300 focus:outline-none"
          />
          <Search
          ...
          {agents.map((agent) => (
            <div key={agent.id} className="bg-gray-800 rounded-lg p-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="text-purple-300">{agent.name}</div>
              </div>
